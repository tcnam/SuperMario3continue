...
#define FIREFLOWER_TIMEWAIT_FORSHOOT	500

#define RELATIVE_POSITION_Y_FIREBALL	5
#define RELATIVE_POSITION_X_LEFT_FIREBALL	2
#define RELATIVE_POSITION_X_RIGHT_FIREBALL	18

#define BONUS_DISTANCE_NOT_SHOWUP			30
#define BONUS_DISTANCE_NOT_SHOWUP2			40
